ser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'if'", "'in'", "'for'", "'new'", "'use'", 
                     "'fn'", "'else'", "'class'", "'mut'", "'return'", "'static'", 
                     "'foreach'", "'while'", "'break'", "'continue'", "<INVALID>", 
    ...
    symbolicNames = [ "<INVALID>", "IF", "IN", "FOR", "NEW", "USE", "FUNC", 
                      "ELSE", "CLASS", "MUTABLE", "RETURN", "STATIC", "FOREACH", 
                      "WHILE", "BREAK", "CONTINUE", "INT", "FLOAT", "STRING", 
                      "STRING_POINTER", "BOOL", "ID", "ADD", "SUB", "MUL", 
    ...
    RULE_whileStmt = 8
    RULE_useStmt = 9
    RULE_forRangeStmt = 10
    RULE_foreachStmt = 11
    RULE_funcName = 12
    RULE_genericParams = 13
    RULE_funcAssign = 14
    RULE_varAssign = 15
    RULE_propertyDecl = 16
    RULE_methodDecl = 17
    RULE_classAssign = 18
    RULE_classDecl = 19
    RULE_arg = 20
    ...
    RULE_relational = 27
    RULE_addition = 28
    RULE_multiplication = 29
    RULE_unary = 30
    RULE_postfix = 31
    RULE_primary = 32

    ruleNames =  [ "program", "type", "stmt", "bodyStmts", "body", "ifStmt", 
                   "elseifStmt", "elseStmt", "whileStmt", "useStmt", "forRangeStmt", 
                   "foreachStmt", "funcName", "genericParams", "funcAssign", 
                   "varAssign", "propertyDecl", "methodDecl", "classAssign", 
                   "classDecl", "arg", "args", "param", "params", "expr", 
                   "ternary", "logical", "relational", "addition", "multiplication", 
    ...
    def program(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 584132279162) != 0):
                self.state = 66
                self.stmt()
                self.state = 71
                self._errHandler.sync(self)
    ...
    class StmtContext(ParserRuleContext):
        ...
        def classAssign(self):
            return self.getTypedRuleContext(ByteParser.ClassAssignContext,0)
        ...
        def foreachStmt(self):
            return self.getTypedRuleContext(ByteParser.ForeachStmtContext,0)
    ...
    def bodyStmts(self):
        ...
        try:
            ...
            if token in [1, 3, 4, 5, 6, 8, 9, 11, 12, 13, 16, 17, 18, 19, 20, 21, 22, 23, 35, 39]:
    ...
    def body(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 584132329338) != 0):
                self.state = 105
                self.bodyStmts()
                self.state = 110
                self._errHandler.sync(self)
    ...
    def forRangeStmt(self):
        ...
        self.enterRule(localctx, 20, self.RULE_forRangeStmt)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 140
    ...
    class ForeachStmtContext(ParserRuleContext):
        ...
        def FOREACH(self):
            return self.getToken(ByteParser.FOREACH, 0)
        ...
        def getRuleIndex(self):
            return ByteParser.RULE_foreachStmt
    ...
    def foreachStmt(self):
        ...
        localctx = ByteParser.ForeachStmtContext(self, self._ctx, self.state)
        self.enterRule(localctx, 22, self.RULE_foreachStmt)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 152
            self.match(ByteParser.FOREACH)
            self.state = 153
            self.match(ByteParser.ID)
            self.state = 154
            self.match(ByteParser.IN)
    ...
    class GenericParamsContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return ByteParser.RULE_genericParams
    ...
    def genericParams(self):
        ...
        localctx = ByteParser.GenericParamsContext(self, self._ctx, self.state)
        self.enterRule(localctx, 26, self.RULE_genericParams)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 173
            self.match(ByteParser.LT)
            self.state = 174
            self.match(ByteParser.ID)
            self.state = 179
            self._errHandler.sync(self)
    ...
    class FuncAssignContext(ParserRuleContext):
        ...
        def genericParams(self):
            return self.getTypedRuleContext(ByteParser.GenericParamsContext,0)
    ...
    def funcAssign(self):
        ...
        self.enterRule(localctx, 28, self.RULE_funcAssign)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 185
    ...
    def varAssign(self):
        ...
        self.enterRule(localctx, 30, self.RULE_varAssign)
        self._la = 0 # Token type
        try:
            self.state = 219
            self._errHandler.sync(self)
    ...
    class PropertyDeclContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return ByteParser.RULE_propertyDecl
    ...
    def propertyDecl(self):
        ...
        localctx = ByteParser.PropertyDeclContext(self, self._ctx, self.state)
        self.enterRule(localctx, 32, self.RULE_propertyDecl)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 221
            self.type_(0)
    ...
    class MethodDeclContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return ByteParser.RULE_methodDecl
    ...
    def methodDecl(self):
        ...
        localctx = ByteParser.MethodDeclContext(self, self._ctx, self.state)
    ...
    class ClassAssignContext(ParserRuleContext):
        __slots__ = 'parser'
        ...
        def CLASS(self):
            return self.getToken(ByteParser.CLASS, 0)
        ...
        def classDecl(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(ByteParser.ClassDeclContext)
            else:
                return self.getTypedRuleContext(ByteParser.ClassDeclContext,i)


        def getRuleIndex(self):
            return ByteParser.RULE_classAssign
    ...
    def classAssign(self):
        ...
        localctx = ByteParser.ClassAssignContext(self, self._ctx, self.state)
        self.enterRule(localctx, 36, self.RULE_classAssign)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 226
            self.match(ByteParser.CLASS)
            self.state = 227
            self.match(ByteParser.ID)
            self.state = 228
            self.match(ByteParser.LBRACE)
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 2099264) != 0):
                self.state = 229
                self.classDecl()
                self.state = 234
                self._errHandler.sync(self)
    ...
    class ClassDeclContext(ParserRuleContext):
        ...
        def propertyDecl(self):
            return self.getTypedRuleContext(ByteParser.PropertyDeclContext,0)


        def methodDecl(self):
            return self.getTypedRuleContext(ByteParser.MethodDeclContext,0)


        def getRuleIndex(self):
            return ByteParser.RULE_classDecl
    ...
    def classDecl(self):
        ...
        localctx = ByteParser.ClassDeclContext(self, self._ctx, self.state)
    ...
    def ternary(self):
        ...
        self.enterRule(localctx, 50, self.RULE_ternary)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 267
            self.logical()
    ...
    def addition(self):
        ...
        self.enterRule(localctx, 56, self.RULE_addition)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 291
    ...
    def multiplication(self):
        ...
        self.enterRule(localctx, 58, self.RULE_multiplication)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 299
    ...
    class NewArrayContext(PrimaryContext):
        ...
        def LBRACK(self):
            return self.getToken(ByteParser.LBRACK, 0)
        def INT(self):
            return self.getToken(ByteParser.INT, 0)
        def RBRACK(self):
            return self.getToken(ByteParser.RBRACK, 0)
    ...
    def primary(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                localctx = ByteParser.NewArrayContext(self, localctx)
                self.enterOuterAlt(localctx, 3)
                self.state = 341
                self.match(ByteParser.NEW)
                self.state = 342
                self.type_(0)
                self.state = 343
                self.match(ByteParser.LBRACK)
                self.state = 344
                self.match(ByteParser.INT)
                self.state = 345
                self.match(ByteParser.RBRACK)
                pass
