...
def serializedATN():
    return [
        ...
        34,36,38,40,42,44,46,48,50,52,54,56,58,60,62,64,0,7,1,0,22,35,1,
        0,22,26,1,0,33,34,1,0,27,32,1,0,22,23,1,0,24,26,2,0,22,23,35,35,
        ...
        1,0,0,0,72,73,5,0,0,1,73,1,1,0,0,0,74,75,6,1,-1,0,75,76,5,21,0,0,
        76,81,1,0,0,0,77,78,10,1,0,0,78,80,5,44,0,0,79,77,1,0,0,0,80,83,
        ...
        5,41,0,0,104,106,3,6,3,0,105,104,1,0,0,0,106,109,1,0,0,0,107,105,
        1,0,0,0,107,108,1,0,0,0,108,110,1,0,0,0,109,107,1,0,0,0,110,111,
        5,42,0,0,111,9,1,0,0,0,112,113,5,1,0,0,113,114,3,48,24,0,114,118,
        ...
        5,5,0,0,137,138,5,18,0,0,138,19,1,0,0,0,139,140,5,10,0,0,140,141,
        3,48,24,0,141,21,1,0,0,0,142,143,5,3,0,0,143,144,5,21,0,0,144,145,
        5,2,0,0,145,146,3,48,24,0,146,147,5,45,0,0,147,150,3,48,24,0,148,
        149,5,45,0,0,149,151,3,48,24,0,150,148,1,0,0,0,150,151,1,0,0,0,151,
        152,1,0,0,0,152,153,3,8,4,0,153,23,1,0,0,0,154,155,3,2,1,0,155,156,
        5,36,0,0,156,158,1,0,0,0,157,154,1,0,0,0,157,158,1,0,0,0,158,159,
        1,0,0,0,159,168,5,21,0,0,160,168,7,0,0,0,161,162,3,2,1,0,162,163,
        5,36,0,0,163,165,1,0,0,0,164,161,1,0,0,0,164,165,1,0,0,0,165,166,
        1,0,0,0,166,168,5,4,0,0,167,157,1,0,0,0,167,160,1,0,0,0,167,164,
        1,0,0,0,168,25,1,0,0,0,169,170,5,30,0,0,170,175,5,21,0,0,171,172,
        5,37,0,0,172,174,5,21,0,0,173,171,1,0,0,0,174,177,1,0,0,0,175,173,
        1,0,0,0,175,176,1,0,0,0,176,178,1,0,0,0,177,175,1,0,0,0,178,179,
        5,29,0,0,179,27,1,0,0,0,180,182,5,12,0,0,181,180,1,0,0,0,181,182,
        ...
        5,39,0,0,189,191,3,46,23,0,190,189,1,0,0,0,190,191,1,0,0,0,191,192,
        1,0,0,0,192,195,5,40,0,0,193,194,5,43,0,0,194,196,3,2,1,0,195,193,
        1,0,0,0,195,196,1,0,0,0,196,197,1,0,0,0,197,198,3,8,4,0,198,29,1,
        0,0,0,199,202,5,21,0,0,200,201,5,36,0,0,201,203,5,21,0,0,202,200,
        1,0,0,0,202,203,1,0,0,0,203,205,1,0,0,0,204,206,7,1,0,0,205,204,
        1,0,0,0,205,206,1,0,0,0,206,207,1,0,0,0,207,208,5,38,0,0,208,216,
        3,48,24,0,209,211,5,9,0,0,210,209,1,0,0,0,210,211,1,0,0,0,211,212,
        1,0,0,0,212,213,5,21,0,0,213,214,5,38,0,0,214,216,3,48,24,0,215,
        199,1,0,0,0,215,210,1,0,0,0,216,31,1,0,0,0,217,218,3,2,1,0,218,219,
        5,21,0,0,219,33,1,0,0,0,220,221,3,28,14,0,221,35,1,0,0,0,222,223,
        5,8,0,0,223,224,5,21,0,0,224,228,5,41,0,0,225,227,3,38,19,0,226,
        225,1,0,0,0,227,230,1,0,0,0,228,226,1,0,0,0,228,229,1,0,0,0,229,
        231,1,0,0,0,230,228,1,0,0,0,231,232,5,42,0,0,232,37,1,0,0,0,233,
        ...
        0,240,241,5,37,0,0,241,243,3,40,20,0,242,240,1,0,0,0,243,246,1,0,
        ...
        0,250,251,3,2,1,0,251,252,5,21,0,0,252,45,1,0,0,0,253,258,3,44,22,
        0,254,255,5,37,0,0,255,257,3,44,22,0,256,254,1,0,0,0,257,260,1,0,
        ...
        1,0,0,0,307,61,1,0,0,0,308,320,3,64,32,0,309,310,5,36,0,0,310,316,
        5,21,0,0,311,313,5,39,0,0,312,314,3,42,21,0,313,312,1,0,0,0,313,
        314,1,0,0,0,314,315,1,0,0,0,315,317,5,40,0,0,316,311,1,0,0,0,316,
        ...
        5,21,0,0,324,326,5,39,0,0,325,327,3,42,21,0,326,325,1,0,0,0,326,
        327,1,0,0,0,327,328,1,0,0,0,328,348,5,40,0,0,329,330,5,4,0,0,330,
        331,3,2,1,0,331,333,5,39,0,0,332,334,3,42,21,0,333,332,1,0,0,0,333,
        334,1,0,0,0,334,335,1,0,0,0,335,336,5,40,0,0,336,348,1,0,0,0,337,
        338,5,39,0,0,338,339,3,48,24,0,339,340,5,40,0,0,340,348,1,0,0,0,
        341,348,5,16,0,0,342,348,5,17,0,0,343,348,5,18,0,0,344,348,5,19,
        0,0,345,348,5,20,0,0,346,348,5,21,0,0,347,323,1,0,0,0,347,329,1,
...
class ByteParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'if'", "'in'", "'for'", "'new'", "'use'", 
                     ...
                     "'static'", "'while'", "'break'", "'continue'", "<INVALID>", 
    ...
    symbolicNames = [ "<INVALID>", "IF", "IN", "FOR", "NEW", "USE", "FUNC", 
                      ...
                      "DOUBLEDOT", "COMMENT", "MULTILINE_COMMENT", "WHITESPACE" ]
    ...
    def program(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 584132277114) != 0):
                self.state = 66
                self.stmt()
                self.state = 71
                self._errHandler.sync(self)
    ...
    def bodyStmts(self):
        ...
        try:
            ...
            if token in [1, 3, 4, 5, 6, 8, 9, 12, 13, 16, 17, 18, 19, 20, 21, 22, 23, 35, 39]:
    ...
    def body(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 584132328314) != 0):
                self.state = 104
                self.bodyStmts()
                self.state = 109
                self._errHandler.sync(self)
    ...
    def classAssign(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 2101312) != 0):
                self.state = 225
                self.classDecl()
                self.state = 230
                self._errHandler.sync(self)
